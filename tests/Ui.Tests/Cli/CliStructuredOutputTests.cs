...
public sealed class CliStructuredOutputTests(ITestOutputHelper output) : IDisposable
{
    ...
    [
        ...
        "plot.zoom.malformed",
        // `rail` (brief-railrf-10-cli-verb.md). Every one of these NAMES A FLAG, because each is a
        // refusal the window answers by turning a control red (R-rail7-4) and a terminal has no
        // control to turn.
        "rail.aggressor.malformed",
        "rail.anchor.malformed",
        "rail.args.path-required",
        "rail.args.rows-malformed",
        "rail.artwork.not-found",
        "rail.artwork.unreadable",
        "rail.artwork.unstated",
        "rail.document.none-beside",
        ...
        "rail.output.write-failed",
        "rail.parts.unreadable",
        "rail.path.not-a-rail",
        "rail.path.not-found",
        "rail.rail.none",
        "rail.rail.unknown",
        "rail.reference.unknown-layer",
        "rail.reference.unstated",
        "rail.run.cancelled",
        "rail.run.finding",
        "rail.run.note",
        "rail.run.refused",
        "rail.set.not-applicable",
        "rail.source.field-malformed",
        ...
        // brief-em3d-5 — `render` on a 3D EM setup.
        "render.em3d.multiple-views",
        "render.em3d.not-3d",
        "render.em3d.not-applicable",
        "render.em3d.planar",
        "render.em3d.problems",
        "render.em3d.section-malformed",
        "render.em3d.unbuildable",
        "render.em3d.unit-required",
        "render.em3d.view-required",
