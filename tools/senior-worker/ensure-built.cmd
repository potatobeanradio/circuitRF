...
zig cc -target x86_64-windows-gnu -O2 -std=gnu11 -Wall -Wextra -Wno-unused-parameter -DCRF_HOST_DLL -shared ^
    "%here%senior_worker.c" "%here%crf-model-host.def" -o "%dll%" -lm ^
    >"%TEMP%\crf-senior-worker-build.log" 2>&1
zig cc -target x86_64-windows-gnu -O2 -std=gnu11 -Wall -Wextra -Wno-unused-parameter -DCRF_HOST_STUB ^
